...
Aisle_1 = [
    ...
    {"name": "Banana", "type": "fruit", "description": "Can be eaten as snack or used as egg replacement for backing.",
     "vegan": "Yes"},
    {"name": "Melon", "type": "fruit", "description": "Sweet and in the moment in season.", "vegan": "Yes"},
    {"name": "Tomato", "type": "vegetable", "description": "Good for sauce and salats.", "vegan": "Yes"},
    {"name": "Garlic", "type": "vegetable", "description": "Good seasoning.", "vegan": "Yes"},
    {"name": "Potatoes", "type": "vegetable", "description": "A stable for every meal", "vegan": "Yes"}
]
Aisle_2 = [
...
Aisle_3 = [
    ...
    {"name": "Tofu", "type": "cooled food", "description": "A protein-source.", "vegan": "Yes"}
]
Aisle_4 = [
    {"name": "Rice", "type": "food", "description": "A grain, a stable for warm meals.", "vegan": "Yes"},
    {"name": "Noodles", "type": "food", "description": "Can be vegan, you are unsure.", "vegan": "No"},
    {"name": "Bread", "type": "food", "description": "A stable for every meal, can be vegan.", "vegan": "Yes"}
]
